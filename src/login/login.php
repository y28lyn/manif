                    ...
                    <form action="" method="post">
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between mb-2">
                                ...
                                <a href="#" class="text-sm text-gray-400 focus:text-[#FFF] hover:text-[#FFF] hover:underline">Mot de passe oublié?</a>
                            </div>
                        ...
                        <div class="mt-6">
                            <button
                                type="submit"
                                class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#E84545] rounded-md hover:bg-[#903749] focus:outline-none focus:bg-[#903749] focus:ring focus:ring-[#FFF] focus:ring-opacity-50">
                                Se connecter
                            </button>
                        </div>
                    </form>
