                ...
                <div class="mt-8">
                    <form action="" method="post">
                        <div class="flex flex-row gap-5">
                            <div>
                                <div>
                                    ...
                                    <input type="text" name="nom"  placeholder="Votre nom" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md placeholder-gray-600bg-gray-900 text-gray-900 border-gray-700 focus:border-[#FFF] focus:ring-[#FFF] focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                <div>
                                    <label for="prenom" class="block mb-2 text-sm text-gray-200 mt-2">Prenom</label>
                                    <input type="text" name="prenom" placeholder="Votre prenom" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md placeholder-gray-600bg-gray-900 text-gray-900 border-gray-700 focus:border-[#FFF] focus:ring-[#FFF] focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                <div>
                                    <label for="mail" class="block mb-2 text-sm text-gray-200 mt-2">E-mail</label>
                                    <input type="email" name="mail" placeholder="Votre e-mail" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md placeholder-gray-600bg-gray-900 text-gray-900 border-gray-700 focus:border-[#FFF] focus:ring-[#FFF] focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                            </div>
                            <div>
                                <div>
                                    <label for="login" class="block mb-2 text-sm text-gray-200 mt-2">Login</label>
                                    <input type="text" name="login" placeholder="Votre login" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md placeholder-gray-600bg-gray-900 text-gray-900 border-gray-700 focus:border-[#FFF] focus:ring-[#FFF] focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                <div>
                                    <label for="mdp" class="block mb-2 text-sm text-gray-200 mt-2">Mot de passe</label>
                                    <input type="password" name="mdp" placeholder="Votre mot de passe" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md placeholder-gray-600bg-gray-900 text-gray-900 border-gray-700 focus:border-[#FFF] focus:ring-[#FFF] focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-6 flex flex-row gap-5">
                            <button
                                type="submit"
                                class="w-1/2 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#5b629f] rounded-md hover:bg-[#494e80] focus:outline-none focus:bg-[#494e80] focus:ring focus:ring-[#FFF] focus:ring-opacity-50">
                                S'inscrire
                            </button>
                            <a 
                                href="login.php" 
                                name="deconnexion" 
                                class="w-1/2 px-4 py-2 tracking-wide text-center text-white transition-colors duration-200 transform bg-red-500 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600 focus:ring focus:ring-[#FFF] focus:ring-opacity-50">
                            Annuler
                        </a>
                        </div>
                    </form>
